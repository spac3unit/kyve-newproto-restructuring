...
* One validator does not vote for one proposal but votes afterwards again
* One validator does not vote for multiple proposals but votes afterwards again
* One validator does not vote for multiple proposals and reaches max points
* One validator does not vote for multiple proposals and submit a bundle proposal
...
var _ = Describe("Bundles module integration tests", Ordered, func() {
	...
	It("Produce a valid bundle with one validator", func() {
		// ARRANGE
